...
import com.jwt.example.JwtAuthenticaion.service.CustomUserDetailService;
...
public class AppConfig {
    ...
    public UserDetailsService userDetailsService() {
        ...
        return new InMemoryUserDetailsManager(userDetail1,userDetail);
    }


//    @Bean
//    public CustomUserDetailService userDetailService(){
//        return new CustomUserDetailServic
//    }
    @Bean
